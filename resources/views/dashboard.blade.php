...
<head>
    ...
    <title>Teacher Dashboard - Edu Platform</title>
...
<body>
    ...
    <div class="content">
        <div class="profile-card">
            <h2>Welcome, {{ $user->first_name }}, to your Teacher Dashboard!</h2>
        </div>
        <div class="options-card">
            <h3>Teacher Options</h3>
            <div class="btn-group">
                <a href="/courses" class="btn btn-custom">Manage Courses</a>
                <a href="/add_courses" class="btn btn-custom">Add Course</a>
                <a href="/students" class="btn btn-custom">Manage Students</a>
                <a href="/add_students" class="btn btn-custom">Add Student</a>
            </div>
