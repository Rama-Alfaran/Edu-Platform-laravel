...
<body>
    <div class="container">
        ...
        <form method="POST" action="/add_courses" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" id="base_mark" name="base_mark" value="{{ old('base_mark', 100) }}" min="1" max="1000" required>
            </div>
